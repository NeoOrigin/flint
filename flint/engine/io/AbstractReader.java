...
public abstract class AbstractReader implements IReader {
    ...
    public Map<String, String> readRecordMapped() throws IOException {
        ...
        String[] cols = matchLengthOf( m_columns, rec,  "column", true  ); // Add indexes if column names missing
        String[] rows = matchLengthOf( rec,       cols, null,     false ); // Set missing cells to null
